          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-col flex-1">
            ...
            {showModuleEditor && (
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="font-medium text-gray-800">编辑模块</h4>
                  <button
                ...
                <div className="space-y-3">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-200 rounded-xl focus:border-golden focus:ring-2 focus:ring-golden/20 outline-none"
                    placeholder="模块名称"
                  />
                  <textarea
                    value={editModulePrompt}
                    onChange={(e) => setEditModulePrompt(e.target.value)}
                    className="w-full px-3 py-3 border border-gray-200 rounded-xl focus:border-golden focus:ring-2 focus:ring-golden/20 outline-none resize-none text-sm"
                    rows={6}
                    placeholder="模块提示词..."
                  />
                  <button
                    onClick={handleSaveModule}
                    className="w-full px-4 py-2 bg-golden text-white rounded-xl font-semibold hover:opacity-90 transition-colors"
                  >
                    保存
                  </button>
                </div>
